...
class TestFileSettings(unittest.TestCase):
    def test_default_file_setting(self):
        fs = FileSettings()
        self.assertEqual(fs.project_dir, "/media/usb1/projects/timelapse",
            "Default project dir is correct")
        self.assertEqual(fs.log_file_name, "take_photo.log",
            "Default log file name is take_photo.log")
        self.assertEqual(fs.log_file(), "/media/usb1/projects/timelapse/take_photo.log",
    ...
    def test_modify_file_settings(self):
        ...
        self.assertEqual(fs.project_dir, "/new/project/dir",
            "Can change the project directory")
        self.assertEqual(fs.log_file_name, "take_photo.log",
            "Default log file name is take_photo.log")
        fs.log_file_name = "new_file_name"
        self.assertEqual(fs.log_file_name, "new_file_name",
            "Can change the log_file_name")
        self.assertEqual(fs.log_file(), "/new/project/dir/new_file_name",
